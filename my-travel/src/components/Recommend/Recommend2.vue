<template>
	<div>
		...
		<div class="personal_recommend_section1">
			...
			<div class="personal_recommend_header">专属推荐<span class="personal_recommend_city">厦门</span>
			</div>
		    <div class="person-wrap_nav" ref="personWrap">
			        <ul class="person-list" ref="personTab">
			          <li class="person-item on">酒店</li>
			          <li class="person-item">门票</li>
			          <li class="person-item">当地玩乐</li>
			          <li class="person-item">跟团游</li>
			          <li class="person-item">定制旅行</li>
			          <li class="person-item">当地玩乐</li>
			          <li class="person-item">自由行</li>
			        </ul>
			</div>
